...
if __name__ == "__main__":
    ...
    with open(NN_SWING_TRANS_PATH) as json_file:
        nn_swing_trans_mat = json.load(json_file)

    acc_mat = gen_acc_mat(pitches)
    pitcher_id, batter_id = 543037, 448801
    # nn_swing_trans_mat = gen_swing_trans_matrix(pitcher_id, batter_id)
    # print(nn_swing_trans_mat)
