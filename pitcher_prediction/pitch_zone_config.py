...
def gen_acc_mat(pitches: Dict[str, Pitch]) -> dict:
    ...
    for pitch, zones in swing_trans_mat.items():
        ...
        for int_zone in zones:
            trans_prob_mat[pitch][int_zone] = {
                BatActs.TAKE.value: {Outcomes.STRIKE.value: 0, Outcomes.BALL.value: 0},
                BatActs.SWING.value: {
            ...
            if int_zone[-1] == "b":
                trans_prob_mat[pitch][int_zone][BatActs.TAKE.value][
                    Outcomes.BALL.value
                ] = 1
            ...
            if int_zone in acc_mat[pitch]:
                ...
                for act_zone, prob_in_zone in acc_mat[pitch][int_zone].items():
                    ...
                    for outcome, prob_outcome in swing_trans_mat[pitch][
                        act_zone
                    ].items():
                ...
                trans_prob_mat[pitch][int_zone][BatActs.SWING.value] = swing_trans_mat[
                    pitch
                ][int_zone]
